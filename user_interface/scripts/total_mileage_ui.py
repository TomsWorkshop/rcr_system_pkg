...
if rospy.has_param('/total_mileage/clk'):
    CLK = rospy.get_param('/total_mileage/clk')
    
if rospy.has_param('/total_mileage/dio'):
    DIO = rospy.get_param('/total_mileage/dio')
...
def total_mileage(tm):
    rospy.init_node('total_mileage', anonymous=True)
